...
const waUrl = (text: string, number: string = WA_NUMBER): string =>
...
type LandingPageProps = {
    /** Built by routes/web.php from WHATSAPP_NUMBER; the number is reused for every WhatsApp CTA. */
    whatsappUrl?: string;
};

export default function LandingPage({ whatsappUrl }: LandingPageProps) {
    const waNumber = whatsappUrl?.match(/wa\.me\/(\d+)/)?.[1] ?? WA_NUMBER;
    const wa = (text: string): string => waUrl(text, waNumber);
                                ...
                                <div className="[position:relative] [display:flex] [flex-direction:column] [overflow:hidden] [border-radius:24px] [padding:28px] [box-shadow:0_8px_32px_rgba(245,183,0,0.15)] [background:linear-gradient(165deg,#ffffff_0%,#fffbf0_100%)] [border:2px_solid_#F5B700]">
                                    ...
                                    <div className="[display:flex] [flex-direction:column] [gap:6px]">
                                        <TrackedCTA
                                            ...
                                            label="Pricing Self-Study - Mulai Belajar Mandiri"
                                    ...
                                    <TrackedCTA
                                        zone="pricing"
                                        action="whatsapp"
                                        label="Pricing Self-Study - Tanya via WhatsApp"
                                        href={wa(
                                ...
                                <div className="[display:flex] [flex-direction:column] [border-radius:24px] [padding:28px] [box-shadow:0_4px_24px_rgba(0,0,0,0.06)] [border:2px_solid_#e5e7eb]">
                                    ...
                                    <div className="[display:flex] [flex-direction:column] [gap:6px]">
                                        <TrackedCTA
                                            zone="pricing"
                                            action="external_checkout"
                                            label="Pricing Starter - Apply Sekarang"
                                    ...
                                    <TrackedCTA
                                        zone="pricing"
                                        action="whatsapp"
                                        label="Pricing Starter - Tanya via WhatsApp"
                                        href={wa(
                                ...
                                <div className="[position:relative] [display:flex] [flex-direction:column] [overflow:hidden] [border-radius:24px] [padding:28px] [box-shadow:0_16px_56px_rgba(22,163,74,0.2),0_0_0_1px_rgba(22,163,74,0.08)] [background:linear-gradient(165deg,#ffffff_0%,#f0fdf4_100%)] [border:2px_solid_#16a34a]">
                                    ...
                                    <div className="[display:flex] [flex-direction:column] [gap:6px]">
                                        <TrackedCTA
                                            zone="pricing"
                                            action="external_checkout"
                                            label="Pricing Bundling - Apply Sekarang"
                                            href="https://member.fullbrightindonesia.com/paket-premium-toefl-level-starter-live-zoom-intensif-flash-sale"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            onClick={markCheckoutClicked}
                                    ...
                                    <TrackedCTA
                                        zone="pricing"
                                        action="whatsapp"
                                        label="Pricing Bundling - Tanya via WhatsApp"
                                        href={wa(
                                ...
                                <div className="[display:flex] [flex-direction:column] [border-radius:24px] [padding:28px] [box-shadow:0_4px_24px_rgba(0,0,0,0.06)] [border:2px_solid_#e5e7eb]">
                                    ...
                                    <div className="[display:flex] [flex-direction:column] [gap:6px]">
                                        <TrackedCTA
                                            zone="pricing"
                                            action="external_checkout"
                                            label="Pricing Intermediate - Apply Sekarang"
                                    ...
                                    <TrackedCTA
                                        zone="pricing"
                                        action="whatsapp"
                                        label="Pricing Intermediate - Tanya via WhatsApp"
                                        href={wa(
